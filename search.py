...
parser.add_argument('-rtt', help='retention time threshold in sigma', default=1.3, type=float)
...
parser.add_argument('-nprocs', help='number of processes. 0 means auto', default=0, type=int)
