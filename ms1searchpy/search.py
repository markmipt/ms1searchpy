...
def run():
    ...
    parser.add_argument('-ptol_left', help='left border of precursor mass tolerance in ppm', default=0, type=float)
    parser.add_argument('-ptol_right', help='right border of precursor mass tolerance in ppm', default=0, type=float)
    ...
    parser.add_argument('-ci', help='minimum number of isotopes for mass and RT calibration. 0 means autotuning', default=0, type=int)
    parser.add_argument('-csc', help='minimum number of scans for mass and RT calibration. 0 means autotuning', default=0, type=int)
    parser.add_argument('-crt', help='number of PFMs for RT calibration', default=2500, type=int)
    ...
    parser.add_argument('-isowidth', help='EXPERIMENTAL. isowidth', default=0, type=float)
    parser.add_argument('-rt_shift', help='EXPERIMENTAL. rt_shift', default=0.1, type=float)
    parser.add_argument('-acc_frag', help='EXPERIMENTAL. acc_frag', default=0.01, type=float)
